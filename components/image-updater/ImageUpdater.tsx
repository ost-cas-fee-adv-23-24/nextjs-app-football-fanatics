...
const ImageUpdater = ({
  ...
  return (
    ...
    >
      <div className="absolute h-10 w-10 bg-slate-200 z-30 cursor-pointer top-[-15px] left-[-33px] border-transparent border-t-[0] border-b-[50px] border-x-[50px] rotate-[315deg]" />
      <div
